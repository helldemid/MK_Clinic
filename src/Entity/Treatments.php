...
class Treatments
{
	...
	#[ORM\Column(length: 255, options: ['default' => 'placeholder.png'])]
	...
	#[ORM\ManyToOne(targetEntity: TreatmentTime::class)]
	#[ORM\JoinColumn(nullable: true)]
	private ?TreatmentTime $time = null;
	...
	public function getTime(): ?TreatmentTime
	{
		return $this->time;
	}

	public function setTime(?TreatmentTime $time): self
	{
		$this->time = $time;
		return $this;
	}
