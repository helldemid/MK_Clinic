 ...
 */
final class Version20250908211154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE treatments CHANGE image_name image_name VARCHAR(255) DEFAULT \'placeholder.png\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE treatments CHANGE image_name image_name VARCHAR(255) NOT NULL');
    }
}
